...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_dunning_related_invoice',
    download_url='https://github.com:nantic/trytond-account_dunning_related_invoice.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_dunning_related_invoice.git'
    },
    classifiers=[
